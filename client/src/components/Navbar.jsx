  ...
  return (
    <div className="w-full flex justify-between items-center p-4 sm:p-6 sm:px-24 absolute top-0 ">
        ...
        bg-black text-white relative group '>
         ...
         <button className="flex items-center gap-2 border border-gray-500 rounded-full px-6 py-2 text-gray-800 hover:bg-gray-100 transition-all" onClick={()=>navigate('/login')}>Login<img src={assets.arrow_icon}/></button>}
